...
import '../../providers/manga_prov_class.dart';
String urlDef='https://storage.googleapis.com/proudcity/mebanenc/uploads/2021/03/placeholder-image.png';
...
class _mangaInfo extends State<mangaInfo> {
  ...
  Widget build(BuildContext contexts) {
   ...
   return Scaffold(
    ...
    body: Container( width: 500, child: Row(children: [
        FutureBuilder(
          ...
          margin: EdgeInsets.all(10),
           child:Row(
            ...
            children: [
             ...
             SizedBox(child: Image(image: NetworkImage(snapshot.data[index].getImage() ==null? urlDef:snapshot.data![index].getImage()),width: MediaQuery.of(context).size.width*.7,height: MediaQuery.of(context).size.height*.7),width: 100,height: 300,  ),
            ...
            color: const Color.fromARGB(255, 222, 220, 220),),
              Column(children: [            
                 Container(margin: EdgeInsets.all(10),child: Container(child: Center(child: Text(snapshot.data[index].getTitle() ==null? 'placeholder':snapshot.data![index].getTitle()),),height: 50, width: 100, ),height: 20, width: 100,),
                 Container(margin: EdgeInsets.all(10),child: Container(child: Container(margin:EdgeInsets.all(5),child: Text(snapshot.data![index].getDesc() ==null? 'placeholder':snapshot.data![index].getDesc()),),height: 50, width: 100, decoration: BoxDecoration(color: Color.fromARGB(255, 244, 240, 240),borderRadius: BorderRadius.circular(10),),),height:130, width: 200,),
